<?php
// Lehe pealkirja määramine
$pageTitle = "Avaleht";
require_once("header.php");

// Statistika ja andmete laadimine
$stats = arvutaStatistika();
$restoranid = kysiRestoraniAndmed();
// Ainult populaarsete pitsade pärimine
...
<?php else: ?>
    // Sõnum kui populaarseid pitsasid pole
