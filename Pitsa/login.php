...
// Kui juba sisse logitud, suuna ümber vastavale lehele
if (on_sisse_logitud()) {
    if (on_admin()) {
...
// Sisselogimise andmete töötlemine
if (isset($_POST['login_submit'])) {
    if (!empty($_POST['login']) && !empty($_POST['pass'])) {
        $login = trim($_POST['login']);
        $pass = trim($_POST['pass']);

        // Kasutaja andmete otsimine andmebaasist
